...
localparam CONF_MDT_TAG_BIT_WIDTH = 1;   // Axis-B-T1: tag width per entry (0 in V0)
localparam CONF_MDT_CONTEXT_BIT_WIDTH = 1;   // Axis-C-C1: context/history width (0 in V0)
